# Four-case validation runner - V4.2
from multitask_active_controller_v4_2 import scan_csv
import pandas as pd

MODEL="neural_active_controller_v42.joblib"
TESTS={
...
for name,path in TESTS.items():
    print("\n"+"="*74+"\nTESTING V4.2: "+name+"\n"+"="*74)
    outname=f"test_{name.lower()}_v42.csv"
